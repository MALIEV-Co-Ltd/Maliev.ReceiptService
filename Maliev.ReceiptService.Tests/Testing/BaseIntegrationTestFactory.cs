...
/// <summary>
/// Base integration test factory for ReceiptService.
    ...
    where TDbContext : DbContext
{
    ...
    protected override IHost CreateHost(IHostBuilder builder)
    {
        ...
        // This satisfies the authentication extension's requirement
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            // Configure MassTransit to wait until started to avoid race conditions
    ...
    /// <param name="permissions">Permissions to include as separate claims</param>

...
namespace Maliev.ReceiptService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260612124127_AddReceiptExternalPaymentId")]
    partial class AddReceiptExternalPaymentId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Maliev.ReceiptService.Domain.Entities.Receipt", b =>
                {
                    ...
                    b.HasIndex("InvoiceId", "ExternalPaymentId")
                        .IsUnique()
                        .HasDatabaseName("ix_receipts_invoice_id_external_payment_id")
